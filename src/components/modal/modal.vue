<template>
	<fade-in-transition>
		<div :class="currentClass" v-if="isActive">
			...
			<slot name="close" v-if="showX" :aria-close-label="ariaCloseLabel" :close="close">
				<a @click="close" class="cursor-pointer pointer-events-auto absolute right-0 top-0 p-4" :aria-label="ariaCloseLabel">
