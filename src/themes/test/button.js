export default {
	...
	normal: {
		...
		primary: {
			solid: 'text-white bg-primary-400 hover:bg-primary-500 focus:bg-primary-500 border-primary-400 hover:border-primary-600 focus:border-primary-600',
		...
		success: {
			solid: 'text-white bg-success-600 hover:bg-success-700 focus:bg-success-700 border-success-600 hover:border-success-800 focus:border-success-800',
		...
		warning: {
			solid: 'text-white bg-warning-600 hover:bg-warning-700 focus:bg-warning-700 border-warning-600 hover:border-warning-800 focus:border-warning-800',
		...
		danger: {
			solid: 'text-white bg-danger-600 hover:bg-danger-700 focus:bg-danger-700 border-danger-600 hover:border-danger-800 focus:border-danger-800',
		...
		info: {
			solid: 'text-white bg-info-500 hover:bg-info-600 focus:bg-info-600 border-info-500 hover:border-info-700 focus:border-info-700',
